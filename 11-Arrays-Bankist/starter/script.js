...
// Sorting Arrays
// Strings
// const owners = ['Jonas', 'Zach', 'Adam', 'Marza'];
...
function countDogPortion(arr) {
  // 1.
  arr.forEach(dog => (dog.recommendedFood = dog.weight ** 0.75 * 28));
  // 2.
  const sarahsDog = arr.map(dog =>
  ...
  // 5.
console.log(arr.some(dog => dog.curFood === dog.recFood));
...
console.log(arr.some(checkEatingOkay));

// 7.
console.log(arr.filter(checkEatingOkay));

// 8.
// sort it by recommended food portion in an ascending order [1,2,3]
const dogsSorted = arr.slice().sort((a, b) => a.recFood - b.recFood);
console.log(dogsSorted);


}

countDogPortion(dogs);
